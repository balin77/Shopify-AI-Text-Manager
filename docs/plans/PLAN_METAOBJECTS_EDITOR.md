...
### 2.3 Messergebnis — Lauf 3 (2026-08-19, derselbe Shop, alle Schritte). **V1, V3 und V5 sind damit beantwortet.**
...
**Drei Befunde am Messwerkzeug selbst** (alle behoben):
...
~~**Bis V5 gemessen ist, nimmt die Oberfläche (b) an** und sagt das so.~~ **Erledigt:** V5 ist (a), siehe §2.3 — die Oberfläche sagt jetzt das Gemessene.
