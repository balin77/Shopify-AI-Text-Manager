...
export const DEFAULT_PRODUCT_INSTRUCTIONS: EntityInstructions = {
  ...
  titleInstructions: 'Maximal 60 Zeichen. Nenne Material, Hauptmerkmal und einen Vorteil. Verwende gehobene, aber verständliche Sprache. Keine übertriebenen Superlative.',
...
export const DEFAULT_COLLECTION_INSTRUCTIONS: EntityInstructions = {
  ...
  titleInstructions: 'Maximal 50 Zeichen. Beschreibe die Produktkategorie prägnant. Verwende das Hauptkeyword. Füge ein USP hinzu (handgefertigt, bio, luxus, etc.).',
  ...
  handleInstructions: 'Nur Kleinbuchstaben und Bindestriche. Keine Umlaute. 2-4 Keywords. Maximal 40 Zeichen. Beschreibe die Produktkategorie. SEO-freundlich und URL-lesbar.',
...
export const DEFAULT_BLOG_INSTRUCTIONS: EntityInstructions = {
  ...
  titleInstructions: 'Maximal 60 Zeichen. Verwende Zahlen wenn möglich (5 Tipps, 7 Wege, etc.). Kommuniziere klar den Nutzen. Sprich den Leser direkt an. Verwende Power-Words (ultimativ, einfach, bewiesen).',
  ...
  handleInstructions: 'Nur Kleinbuchstaben und Bindestriche. Keine Umlaute. 3-5 Keywords. Maximal 60 Zeichen. Beschreibe das Thema des Artikels. SEO-optimiert und sprechend.',
...
export const DEFAULT_PAGE_INSTRUCTIONS: EntityInstructions = {
  ...
  titleInstructions: 'Maximal 60 Zeichen. Klar und beschreibend. Bei "Über uns": Jahr der Gründung oder USP. Bei "Kontakt": Erreichbarkeit betonen. Bei "AGB/Datenschutz": Sachlich und professionell.',
  ...
  handleInstructions: 'Nur Kleinbuchstaben und Bindestriche. Keine Umlaute. 2-4 Keywords. Maximal 40 Zeichen. Beschreibt den Seiteninhalt klar. Standard-Handles: uber-uns, kontakt, impressum, datenschutz, agb, versand, widerruf.',
