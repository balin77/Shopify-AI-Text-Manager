...
import { prepareActionContext } from "./product/shared/action-context";

// Import action handlers
import {
  handleGenerateAIText,
  handleFormatAIText,
} from "./product/ai-generation.actions";
import {
  handleTranslateField,
  handleTranslateSuggestion,
} from "./product/translation.actions";
import {
  handleTranslateAll,
  handleTranslateFieldToAllLocales,
} from "./product/translation-bulk.actions";
import { handleUpdateProduct } from "./product/update.actions";
import { handleTranslateOption } from "./product/options.actions";
import {
  handleGenerateAltText,
  handleGenerateAllAltTexts,
  handleTranslateAltText,
} from "./product/alt-text.actions";
