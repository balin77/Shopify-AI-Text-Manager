...
export const en: Translation = {
  ...
  bulkEditor: {
    ...
    retranslationCapped: "For {count} further row(s) the outdated translations were deleted instead of rewritten: one save starts a limited number of background runs. Save those rows separately to have them re-translated too.",
