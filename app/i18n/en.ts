...
export const en: Translation = {
  ...
  tasks: {
    ...
    resourceType: {
      ...
      // single item.
      seo: "SEO",
      templateTitles: "Email templates",
    },
    fieldType: {
      title: "Title",
      description: "Description",
    ...
    resultLabels: {
      ...
      characters: "Characters",
      crawlCapped: "Crawl hit its page limit — not every page was visited.",
      demotedToSecondary: "Demoted to secondary",
      errors: "Errors",
      ...
      galleryVideosMissingDate: "Gallery videos without an upload date",
      galleryVideosVimeo: "Products with Vimeo gallery videos",
      headDrift: "Pages whose head tags drifted",
      internalLinksCapped: "The pending-suggestion limit was reached — some matches were not saved.",
      items: "Items",
      ...
      mediaVideosMissingDate: "Product videos without an upload date",
      ...
      synced: "Re-synced",
      synonymRequests: "AI synonym requests",
      targetsConsidered: "Link targets considered",
      total: "Total",
