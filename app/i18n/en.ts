...
export const en: Translation = {
  ...
  seo: {
    ...
    structuredDataPage: {
      ...
      introStep1: "**Step 1** shows what your pages deliver today.",
      introStep2: "**Step 2** checks whether your product data is enough for a rich result.",
      introStep3: "**Step 3** switches on individual elements — but only those nobody delivers yet.",
