...
export const en: Translation = {
  ...
  settings: {
    ...
    translationsVariantKeys: "Variant match keys",
    translationsVariantKeysDescription: "Stable ASCII keys per option value for SKU and image matching. Created automatically when variants are saved.",
    translationsVariantKeysEmpty: "No variant keys stored yet.",
    translationsVariantOriginal: "Display name",
    translationsVariantSavedAs: "Match key",
    plan: "Plan",
    feedback: "Feedback",
    // Feedback Tab
