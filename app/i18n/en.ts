...
export const en: Translation = {
  ...
  tasks: {
    ...
    resultLabels: {
      ...
      retranslationsCapped: "Deleted instead (cap reached)",
      skipped: "Skipped",
  ...
  bulkEditor: {
    ...
    retranslationCapped: "For {count} further row(s) the outdated translations were deleted instead of rewritten: one save starts at most 25 background runs. Save those rows separately to have them re-translated too.",
