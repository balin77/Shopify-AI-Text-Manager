...
export const en: Translation = {
  ...
  seo: {
    ...
    sitemapPage: {
      ...
      introBody: "Shopify generates your sitemap.xml automatically — it isn't directly editable. The documented lever is the seo.hidden metafield: setting it removes the page from the sitemap AND sets noindex. Clearing it makes the page visible again. Below you'll find suggestions (empty collections, thin content, archived products) that you can apply or revert with one click — a suggestion only counts as applied once Shopify confirms it.",
