...
export const en: Translation = {
  ...
  seo: {
    ...
    aeoPage: {
      ...
      referralNoneEver: "No visit from an AI answer has been reported yet. That is normal for smaller shops — but it can also mean the \"JSON-LD Structured Data\" app embed is not enabled in your theme; without it nothing is counted.",
