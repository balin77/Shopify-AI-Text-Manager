  ...
  seo: {
    ...
    structuredDataPage: {
      ...
      activation: {
        ...
        socialOriginUnknownHint: "No marker from this app was found — the marker ships with this update. The attribution to your theme below stays unproven until the next crawl.",
        ...
        originUnknownHint: "No marker from this app was found — the attribution to your theme below is therefore very likely, but unproven. A fresh crawl proves it.",
