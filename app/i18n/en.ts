...
export const en: Translation = {
  ...
  directTranslations: {
    ...
    ignoreTranslateNoToggle: "Also capture 3rd-party widgets (ignore translate=\"no\")",
    ignoreTranslateNoHelp: "Review apps like Judge.me set translate=\"no\" to fence off browser auto-translate. Enable this so ContentPilot still scans and translates inside those widgets.",
