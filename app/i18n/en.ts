...
export const en: Translation = {
  ...
  settings: {
    ...
    contentTemplatesDescription: "Reusable prompt templates for AI generation. Create one template per content type (product, collection, blog article, page, policy) and field (title, description, SEO title, meta description, URL handle) — placeholders like {{title}}, {{description}} or {{language}} are replaced with the current content data before the AI call. Mark a template as the default per content type + field so it is applied automatically when that field is generated or formatted.",
    contentTemplatesApplyNote: "Applies to new AI calls only — already generated content stays unchanged until it is regenerated or reformatted. Templates are applied in addition to your custom instructions from the AI settings (custom instructions first, then the template).",
    contentTemplatesNewTemplate: "New template",
    contentTemplatesEditTemplate: "Edit template",
    contentTemplatesName: "Name",
    contentTemplatesContentType: "Content type",
    contentTemplatesField: "Field",
    contentTemplatesPrompt: "Prompt template",
    contentTemplatesAvailableVars: "Available variables: {vars}",
    contentTemplatesIsDefault: "Apply automatically (default for this content type + field)",
    contentTemplatesSave: "Save",
    contentTemplatesCancel: "Cancel",
    contentTemplatesEmptyHeading: "No templates yet",
    contentTemplatesEmptyBody: "Create reusable prompt templates to keep AI output consistent across your catalog.",
    contentTemplatesDefaultBadge: "Default",
    contentTemplatesMakeDefault: "Make default",
    contentTemplatesEditRow: "Edit",
    contentTemplatesDeleteRow: "Delete",
    contentTemplatesContentTypeProducts: "Products",
    contentTemplatesContentTypeCollections: "Collections",
    contentTemplatesContentTypeBlogs: "Blog articles",
    contentTemplatesContentTypePages: "Pages",
    contentTemplatesContentTypePolicies: "Policies",
    contentTemplatesDefaultRaceError: "The default was just changed in another window. Please reload the page and try again.",
    // Glossary tab
    glossary: "Glossary",
    glossaryScopeNote: "Note: the glossary only applies to AI translations, not to generating new content. If you want to steer how the AI creates titles/descriptions, use the \"Content templates\" above or the custom instructions under \"AI settings\".",
  ...
  seo: {
    ...
    bulkMetaPage: {
      intro: "Edit title, SEO title, meta description and handle directly in a grid. Only changed cells are saved.",
      typeLabel: "Type",
      types: {
        product: "Products",
        collection: "Collections",
      ...
      colMetaDescription: "Meta description",
      colHandle: "Handle",
