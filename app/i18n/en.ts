...
export const en: Translation = {
  ...
  content: {
    ...
    metaobjectEntryNoTranslatableFields: "No field of this entry can be translated here \u2014 edit it in the Shopify admin.",
    ...
    redirectNotConfirmed: "The old URL {path} could not be redirected — set it up in Shopify if the old link matters.",
    redirectFailed: "The old URL {path} could not be redirected — set it up in Shopify if the old link matters.",
    redirectBlogArticlesUncovered: "The old blog URL {path} now redirects — the URLs of this blog's articles do not.",
    redirectShadowRemoved: "The old URL {path} now redirects. An existing redirect on the new URL was removed — it would have hidden the page.",
    redirectMissingBlog: "The old article URL was not redirected: its blog is unknown. Set it up in Shopify if the old link matters.",
    redirectLocaleBlogUnknown: "The old article URL was not redirected: the blog's handle is translated too. Set it up in Shopify if needed.",
    reload: "Reload",
    ...
    commerce: {
      ...
      skuBarcodeNotBulk: "SKU and barcode identify one variant each, so they are edited one variant at a time.",
      ...
      notStockedEveryVariant: "not stocked at every variant",
      stockHeading: "Stock",
      ...
      stockUnknown: "Not loaded yet — reload to see the stock.",
      stockUntracked: "Stock is not tracked for this variant — it can be sold without limit.",
      stockUntrackedBulk: "Stock is not tracked for these variants — they can be sold without limit.",
      stockSomeNotTracked: "{n} of {m} variants keep no stock count here and are not in the table — their stock stays as it is.",
      stockBulkHint: "A number under “On hand” is set for EACH of the {n} variants. ≠ means the variants differ here.",
      stockNoItem: "This variant has no inventory record, so its stock cannot be edited here.",
      levelsTruncated: "There is stock at more locations than were loaded.",
      noLevels: "No location holds stock of this.",
    ...
    createModal: {
      ...
      noneOption: "\u2014",
      // What a field IS, in the ❓ beside its label — never as help text under
      // the box. Keyed like `CreateFieldDef.labelKey`.
      fieldHelp: {
        keyword: "Goes into the AI prompt and becomes this item's main keyword.",
        handle: "The part of the URL after /collections/, /products/ and so on. Optional: left empty, Shopify derives it from the title. If it is already taken, Shopify appends a number.",
        tags: "Separate several tags with commas.",
      },
  ...
  settings: {
    ...
    seoFeatureScheduledAudit: "Automatic daily audit",
    ...
    seoAutoAuditLabel: "Daily SEO audit",
  ...
  tasks: {
    ...
    taskType: {
      ...
      // PLAN_TASK_LIST_CLARITY B1 — types that were created but never labelled
      // and therefore rendered their raw identifier as a card heading.
      // `bulkAIGeneration` is deliberately NOT a key of its own: it is the
      // second spelling of `bulkAiGeneration` and resolves through the alias
      // map in task-labels.shared.ts.
      aiFormatting: "Text formatting",
    ...
    resourceType: {
      ...
      // Every site-wide SEO task (8 types) carries this — it belongs to no
      // single item.
      seo: "SEO",
      templateTitles: "Notification templates",
    },
    fieldType: {
      title: "Title",
      description: "Description",
      ...
      "sub-resources": "Options & metafields",
      "direct-translations": "Direct translations",
      autoTranslateExternalChange: "Re-translation after an external change",
      suggest: "Suggestions",
      apply: "Applying",
      multi: "Several fields",
    ...
    notificationsBellLabel: "Messages ({unread} unread of {count})",
    ...
    // ── Expanded task details (PLAN_TASK_LIST_CLARITY §3.3) ───────────────
    resultHeading: "Result",
    failuresHeading: "Failed items",
    failuresMore: "+{n} more",
    detailsLoading: "Loading details…",
    detailsError: "Details could not be loaded.",
    detailsEmpty: "This task recorded no further details.",
    redirectsOverCap: "{n} article(s) got no redirect — their old URLs now return 404.",
    // Read directly by TaskDetailsPanel / MainNavigation — not labelKeys.
    // `{id}` is the numeric tail of a Market GID, `{language}` a locale name.
    marketLabel: "Market {id}",
    localeNotSaved: "{language} — not saved",
    fixAllSubject: "All problems · {resource} {id}",
    partialLocalesHint: "Some languages could not be saved — see the Tasks tab for details.",
    // Same sentence as bulkEditor.translateMissing.noneMissing on purpose:
    // one wording for "there was nothing to translate".
    nothingToDo: "Nothing is missing in the current selection.",
    failureFieldFallback: "Field",
    // One key per labelKey emitted by summariseTaskResult()
    // (task-details.shared.ts). Short noun phrases — the value is printed
    // beside them. The three cap entries carry a whole sentence on purpose:
    // they are rendered as a warning line with no value.
    resultLabels: {
      altTextsGenerated: "Alt texts generated",
      applied: "Applied",
      attempted: "Attempted",
      ...
      crawlFailedReason: "Reason for failure",
      demotedToSecondary: "Keywords demoted to secondary",
      errors: "Errors",
      externalBroken: "External links dead",
      externalChecked: "External links checked",
      externalFound: "External links found",
      externalTimedOut: "External links that timed out",
      externalUnchecked: "External links not checked",
      failed: "Failed",
      failedBatches: "Batches without a usable answer",
      failedFields: "Fields that failed",
      fieldsRejected: "Fields not saved",
      fieldsSkipped: "Fields deliberately skipped",
      fieldsTranslated: "Fields translated",
      file: "File",
      galleryVideoProducts: "Products with gallery videos",
      galleryVideosMissingDate: "Products with a gallery video without an upload date",
      ...
      itemsScanned: "Entries checked",
      keywords: "Keywords",
      localesFailed: "Languages that failed",
      localesSaved: "Languages saved",
      localesTargeted: "Target languages",
      localesTranslated: "Languages translated",
      mediaVideosMissingDate: "Products with a product video without an upload date",
      orphanPages: "Pages with no internal links",
      pagesBlocked: "Pages blocked by a bot shield",
      pagesBroken: "Broken pages",
      pagesCrawled: "Pages crawled",
      pagesDiscovered: "Pages discovered",
      pagesOk: "Pages OK",
      pagesServerError: "Pages with a server error",
      purged: "Stale translations removed",
      redirectsCreated: "Redirects created",
      retranslated: "Re-translated",
      rulesAdvised: "Rules with advice",
      rulesTotal: "Rules checked",
      savedRows: "Rows saved",
      retranslationsStarted: "Re-translated (background)",
      retranslationsCapped: "Not re-translated (cap reached)",
      retranslationsSkipped: "Re-translation did not start",
      skipped: "Skipped",
      skippedDrafts: "Skipped (drafts)",
      skippedHandles: "Skipped URL slugs",
      skippedOverCap: "Skipped (over the limit)",
      sourcesScanned: "Source pages scanned",
      succeeded: "Succeeded",
      suggestionsCreated: "Suggestions created",
      suggestionsUpdated: "Suggestions updated",
      synced: "Re-synced",
      synonymRequests: "AI requests for synonyms",
      targetsConsidered: "Link targets checked",
      total: "Entries in total",
  ...
  seo: {
    ...
    hreflangPage: {
      ...
      coverageSummary: "{translated} of {total} fully translated",
      allTranslated: "All scanned content is fully translated in this language.",
      missingTitle: "{count} items not fully translated",
      translate: "Translate",
      showMore: "Show {count} more",
      showLess: "Show less",
      meaningNote: "An item counts as translated only once every field that has text in your primary language is translated. Previously a single translated field was enough, so this percentage can read lower than before — it was always the same gap, it just wasn't shown.",
      scopeNote: "Checked are title, description, SEO title and SEO description of products, collections, pages and blog articles. Metafields, variant options, theme texts, metaobjects, policies and menus are not part of this figure.",
      byTypeTitle: "By content type",
      typeSummary: "{complete} of {scanned} complete",
    ...
    performancePage: {
      ...
      errors: {
        ...
        dailyLimitReached: "You've reached your daily limit of {limit} tests. The limit resets every day at 00:00 UTC.",
      },
      budgetBadge: "{remaining} of {limit} tests left today",
      budgetExhausted: "Daily limit reached ({used}/{limit}). It resets at 00:00 UTC — tests you already ran stay available.",
      ...
      staleDailyLimitNotice: "Showing a cached result — you've reached your daily limit of {limit} tests. A fresh test is possible again from 00:00 UTC.",
      tabs: {
  ...
  bulkEditor: {
    ...
    retranslationCapped: "For {count} further row(s) the outdated translations were not rewritten: one save starts a limited number of background runs. Depending on your setting they were deleted or left as they were. Save those rows separately to have them re-translated too.",
    retranslationSkipped: "For {count} item(s) the re-translation could not be started — their existing translations were left untouched. Save the item again to retry.",
  ...
  help: {
    ...
    autoTranslateHandles: {
      ...
      tips: [
        ...
        "Languages without a handle of their own get a translated one too — old links to the primary-language handle keep working",
        "Where no redirect can be created the old handle stays — the re-translation never deletes it",
      ],
      details:
        "The translated value is normalised into a valid slug; anything that cannot be normalised is discarded rather than written. A language that had no handle of its own gets a translated one; its previous address (the primary-language handle under the language prefix) is covered by the primary language's redirect, and Shopify forwards it to the translated address. Drafts that were never public need no redirect. The handle also stays as it is when the old address still belongs to another language or another item, for market-specific translations, for blogs (their articles' URLs could not come along), for articles under a blog with a translated handle of its own, when, for an existing translated handle, the \"Redirect when a handle changes\" setting is switched off, or when the translation does not come through. The old translated handle is not deleted in those cases — an outdated address works, a deleted one does not. The same holds in the bulk editor when a save would need more runs than allowed: the other fields then fall back to the delete option, the handle stays.",
    },
    menuActionBar: {
