...
export const en: Translation = {
  ...
  seo: {
    ...
    crawlPage: {
      ...
      errorBotBlocked: "A bot firewall blocked the crawl (repeated 403/429). Check your firewall/bot-protection settings (e.g. Cloudflare) and allow the \"ContentPilotSEO\" user agent.",
    ...
    aeoPage: {
      ...
      llmsAutoOn: "Automatic updates are on: while you're working in the app we check about every half hour in the background whether your catalog changed, and rewrite the file only on a real difference.",
      llmsAutoAfterFirst: "Once the file exists we keep it current automatically — about every half hour in the background, while you're working in the app. It is never created on its own.",
