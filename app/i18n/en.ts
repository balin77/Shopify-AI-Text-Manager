...
export const en: Translation = {
  ...
  settings: {
    ...
    autoTranslateExternalChangesHelp: "When a primary-language text changes — in the Shopify admin, in another app, through an import, or here in ContentPilot — the AI re-translates it instead of only deleting the outdated translation. For products and collections that happens automatically on the next sync; for everything else on the next reload of that item. This spends AI credit without you being present. URL handles are excluded and are still only deleted.",
    autoTranslateExternalChangesPlanHint: "Available from the {plan} plan.",
    translationPurgeSupersededNote: "Not needed for products and collections while texts are re-translated automatically — there the outdated text is replaced rather than deleted. Everywhere else (pages, blogs, articles, policies, metaobjects, theme texts, options, metafields, alt texts) deletion continues: those are only re-translated by a reload, and a translation without its source must not stay live.",
