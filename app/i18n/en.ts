    ...
    structuredDataPage: {
      ...
      activation: {
        ...
        summary: {
          ...
          themeFix: "{count} to fix in the theme: {names}",
          themeFixShort: "{count} in the theme",
        ...
        socialOriginUnknownHint: "Why no origin is shown below: either our Open Graph embed is **off**, or the crawl predates the origin marker — which ships with this update. If the embed is on, the next crawl after the extension release shows the origin.",
        ...
        originUnknownHint: "Why no origin is shown below: either our embed is **off** — in which case your theme serves what you see — or the crawl predates the origin detection. Neither changes the advice: switch nothing on.",
        ...
        themeHint: "You switch your **theme\u2019s** own markup off in the theme editor — this app never touches theme code it does not own.",
        switches: {
        ...
        verdicts: {
          ...
          mixed: "**Inconsistent.** {appPages} of {pages} pages from us, the rest from the theme.",
          ...
          duplicateForeign: "**Fix in the theme.** Duplicated on {duplicatePages} pages, no copy is ours.",
        },
      },
