...
export const en: Translation = {
  ...
  bulkEditor: {
    ...
    retranslationStarted: "{count} translation(s) are being rewritten in the background — follow the progress under Tasks.",
