...
export const en: Translation = {
  ...
  settings: {
    ...
    // App translations (dynamic storefront translation)
    appTranslations: "App translations",
    appTranslationsDescription: "Translate text rendered by third-party apps on your storefront that is not stored in translatable Shopify fields. Define source → target pairs per language; they are applied on your storefront.",
    appTranslationsSeoNote: "These translations are applied in the browser and are NOT indexed by search engines. Use Shopify field translations for SEO-relevant content. Apps rendered inside iframes (e.g. Loox) cannot be translated.",
    appTranslationsEnable: "Enable dynamic storefront translation",
    appTranslationsLanguage: "Language",
    appTranslationsAddHeading: "Add a translation",
    appTranslationsSource: "Original text",
    appTranslationsSourcePlaceholder: "e.g. Write a review",
    appTranslationsTarget: "Translation",
    appTranslationsAdd: "Add",
    appTranslationsEmpty: "No entries yet for this language.",
    appTranslationsNoLocalesHeading: "No additional languages",
    appTranslationsNoLocales: "Add more published languages to your Shopify store first.",
    appTranslationsAiHeading: "Translate with AI",
    ...
    appTranslationsTranslateAllAi: "Translate all with AI",
    appTranslationsSeen: "Seen",
    appTranslationsUse: "Translate",
    appTranslationsDismiss: "Dismiss",
    sku: "SKU",
