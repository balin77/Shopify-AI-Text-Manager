...
export const es: Translation = {
  ...
  settings: {
    ...
    autoTranslateExternalChangesHelp: "Cuando un texto del idioma principal cambia — en el admin de Shopify, en otra app, mediante una importación o aquí en ContentPilot —, la IA lo vuelve a traducir en lugar de solo eliminar la traducción desactualizada. En productos y colecciones ocurre automáticamente en la siguiente sincronización. En páginas, blogs, artículos y políticas ocurre al guardarlas en el editor — si el texto se cambió fuera, en la siguiente recarga del elemento. En el editor masivo esas cuatro se siguen eliminando. Consume crédito de IA sin que estés presente. Los handles de URL quedan excluidos y solo se eliminan.",
    autoTranslateExternalChangesPlanHint: "Disponible a partir del plan {plan}.",
    translationPurgeSupersededNote: "No hace falta para productos y colecciones mientras los textos se vuelvan a traducir automáticamente, ni para páginas, blogs, artículos y políticas cuando las editas en el editor: allí el texto desactualizado se reemplaza en lugar de eliminarse. En el editor masivo, y en metaobjetos, textos del tema, opciones, metacampos y textos alternativos, se sigue eliminando: por ahora nada los vuelve a traducir automáticamente, y una traducción sin su original no puede quedarse publicada.",
