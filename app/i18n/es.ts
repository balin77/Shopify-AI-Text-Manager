...
export const es: Translation = {
  ...
  seo: {
    ...
    aeoPage: {
      ...
      referralNoneEver: "Todavía no se ha registrado ninguna visita desde una respuesta de IA. Es normal en tiendas pequeñas, pero también puede significar que el app embed «JSON-LD Structured Data» no está activado en tu tema; sin él no se cuenta nada.",
