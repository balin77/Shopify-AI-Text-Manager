...
export const es: Translation = {
  ...
  content: {
    ...
    redirectNotConfirmed: "La URL antigua {path} no se pudo redirigir — créala en Shopify si el enlace antiguo te importa.",
    redirectFailed: "La URL antigua {path} no se pudo redirigir — créala en Shopify si el enlace antiguo te importa.",
    redirectBlogArticlesUncovered: "La URL antigua del blog {path} ahora redirige — las URLs de sus artículos no.",
    redirectShadowRemoved: "La URL antigua {path} ahora redirige. Se eliminó una redirección en la URL nueva — habría ocultado la página.",
    redirectMissingBlog: "La URL antigua del artículo no se redirigió: su blog es desconocido. Créala en Shopify si te importa.",
    redirectLocaleBlogUnknown: "La URL antigua del artículo no se redirigió: el identificador del blog también está traducido. Créala manualmente si hace falta.",
    reload: "Recargar",
    ...
    menuRenameIdsReassigned: "Shopify asignó nuevos ids a los elementos renombrados. Sus traducciones existentes quedaron en los ids antiguos y hay que introducirlas de nuevo.",
    menuRenamePurgedTranslations: "Se eliminaron {count} traducción(es) porque su texto de origen cambió (Configuración → Traducciones).",
    ...
    // Setup
    syncFailedTitle: "No se pudo sincronizar todo",
    syncFailedSome: "{count} elemento(s) no se pudieron cargar desde Shopify. Para ellos no cambió nada — el registro indica el motivo.",
    syncFailedAll: "La sincronización no se pudo completar.",
    ...
    commerce: {
      ...
      skuBarcodeNotBulk: "El SKU y el código de barras identifican a una sola variante, así que se editan de una en una.",
      ...
      channelsUnknown: "No se pudieron leer los canales de venta ahora mismo, por eso no aparecen aquí. Inténtalo de nuevo en un momento.",
      ...
      notStockedEveryVariant: "no en todas las variantes",
      ...
      stockUnknown: "Aún no se ha cargado: recarga para ver el inventario.",
      stockUntracked: "Esta variante no lleva control de inventario: se puede vender sin límite.",
      stockUntrackedBulk: "Estas variantes no llevan control de inventario: se pueden vender sin límite.",
      stockSomeNotTracked: "{n} de {m} variantes no llevan inventario aquí y no aparecen en la tabla: su stock se queda como está.",
      stockBulkHint: "Un número en “Disponible en almacén” se aplica a CADA una de las {n} variantes. ≠ significa que las variantes difieren aquí.",
      stockNoItem: "Esta variante no tiene registro de inventario, así que su stock no se puede editar aquí.",
      levelsTruncated: "Hay inventario en más ubicaciones de las que se cargaron.",
      noLevels: "Ninguna ubicación tiene inventario de esto.",
    ...
    createModal: {
      ...
      noneOption: "\u2014",
      // Para qué sirve un campo, en el ❓ junto a la etiqueta y nunca como
      // texto de ayuda bajo la caja. Clave igual que `CreateFieldDef.labelKey`.
      fieldHelp: {
        keyword: "Entra en el prompt de la IA y pasa a ser la palabra clave principal de este elemento.",
        handle: "La parte de la URL después de /collections/, /products/, etc. Opcional: si lo dejas vacío, Shopify lo deriva del título. Si ya está ocupado, Shopify añade un número.",
        tags: "Separa varias etiquetas con comas.",
      },
  ...
  settings: {
    ...
    seoFeatureScheduledAudit: "Auditoría diaria automática",
    ...
    seoAutoAuditLabel: "Auditoría SEO diaria",
  ...
  tasks: {
    ...
    taskType: {
      ...
      // PLAN_TASK_LIST_CLARITY B1 — tipos que se creaban pero no tenían
      // etiqueta y por eso mostraban su identificador crudo como título.
      // `bulkAIGeneration` no lleva clave propia a propósito: es la segunda
      // grafía de `bulkAiGeneration` y se resuelve con el mapa de alias de
      // task-labels.shared.ts.
      aiFormatting: "Formato de texto",
    ...
    resourceType: {
      ...
      templates: "Textos del tema",
      // Cada tarea SEO de toda la tienda (8 tipos) lleva esto — no pertenece a
      // ningún elemento concreto.
      seo: "SEO",
      templateTitles: "Plantillas de notificación",
    },
    fieldType: {
      title: "Título",
      description: "Descripción",
      ...
      altText: "Texto alt",
      altTextTemplate: "Plantilla de texto alt",
      "sub-resources": "Opciones y metacampos",
      "direct-translations": "Traducciones directas",
      autoTranslateExternalChange: "Retraducción tras un cambio externo",
      suggest: "Sugerencias",
      apply: "Aplicación de sugerencias",
      multi: "Varios campos",
      robots: "Reglas de robots.txt",
      llms: "llms.txt",
      agents: "agents.md",
    },
    // Expandable details
    ...
    // ── Detalles desplegados de la tarea (PLAN_TASK_LIST_CLARITY §3.3) ────
    resultHeading: "Resultado",
    failuresHeading: "Elementos fallidos",
    failuresMore: "+{n} más",
    detailsLoading: "Cargando detalles…",
    detailsError: "No se pudieron cargar los detalles.",
    detailsEmpty: "No se guardaron más detalles de esta tarea.",
    redirectsOverCap: "{n} artículo(s) se quedaron sin redirección — sus URLs antiguas ahora devuelven 404.",
    // Las lee directamente TaskDetailsPanel / MainNavigation — no son
    // labelKeys. `{id}` es el número de un GID de mercado y `{language}` un
    // nombre de idioma.
    marketLabel: "Mercado {id}",
    localeNotSaved: "{language} — no se guardó",
    fixAllSubject: "Todos los problemas · {resource} {id}",
    partialLocalesHint: "Algunos idiomas no se pudieron guardar — mira los detalles en la pestaña Tareas.",
    // A propósito la misma frase que bulkEditor.translateMissing.noneMissing:
    // una sola formulación para "no había nada que traducir".
    nothingToDo: "No falta ninguna traducción en la selección actual.",
    failureFieldFallback: "Campo",
    // Una clave por cada labelKey que emite summariseTaskResult()
    // (task-details.shared.ts). Frases nominales cortas — el valor va al lado.
    // Las tres entradas de límite llevan una frase entera a propósito: se
    // muestran como línea de aviso sin valor.
    resultLabels: {
      altTextsGenerated: "Textos alt generados",
      applied: "Aplicados",
      attempted: "Intentados",
      averageScore: "Puntuación media",
      batches: "Lotes de IA",
      capped: "El análisis se detuvo en el límite — no se revisó todo.",
      characters: "Caracteres",
      crawlCapped: "El rastreo alcanzó su límite de páginas — no se visitaron todas.",
      crawlFailedReason: "Motivo del fallo",
      demotedToSecondary: "Palabras clave bajadas a secundarias",
      errors: "Errores",
      externalBroken: "Enlaces externos rotos",
      externalChecked: "Enlaces externos comprobados",
      externalFound: "Enlaces externos encontrados",
      externalTimedOut: "Enlaces externos con tiempo agotado",
      externalUnchecked: "Enlaces externos sin comprobar",
      failed: "Fallidos",
      failedBatches: "Lotes sin respuesta utilizable",
      failedFields: "Campos fallidos",
      fieldsRejected: "Campos no guardados",
      fieldsSkipped: "Campos omitidos deliberadamente",
      fieldsTranslated: "Campos traducidos",
      file: "Archivo",
      galleryVideoProducts: "Productos con vídeos de galería",
      galleryVideosMissingDate: "Productos con un vídeo de galería sin fecha de subida",
      ...
      itemsScanned: "Entradas comprobadas",
      keywords: "Palabras clave",
      localesFailed: "Idiomas fallidos",
      localesSaved: "Idiomas guardados",
      localesTargeted: "Idiomas de destino",
      localesTranslated: "Idiomas traducidos",
      mediaVideosMissingDate: "Productos con un vídeo de producto sin fecha de subida",
      orphanPages: "Páginas sin enlaces internos",
      pagesBlocked: "Páginas bloqueadas por una protección antibots",
      pagesBroken: "Páginas rotas",
      pagesCrawled: "Páginas rastreadas",
      pagesDiscovered: "Páginas descubiertas",
      pagesOk: "Páginas correctas",
      pagesServerError: "Páginas con error de servidor",
      purged: "Traducciones obsoletas eliminadas",
      redirectsCreated: "Redirecciones creadas",
      retranslated: "Retraducidas",
      rulesAdvised: "Reglas con recomendación",
      rulesTotal: "Reglas comprobadas",
      savedRows: "Filas guardadas",
      retranslationsStarted: "Retraducidas (en segundo plano)",
      retranslationsCapped: "No retraducidas (límite alcanzado)",
      retranslationsSkipped: "La retraducción no se inició",
      skipped: "Omitidos",
      skippedDrafts: "Omitidos (borradores)",
      skippedHandles: "URL slugs omitidos",
      skippedOverCap: "Omitidos (por encima del límite)",
      sourcesScanned: "Páginas de origen analizadas",
      succeeded: "Correctos",
      suggestionsCreated: "Sugerencias creadas",
      suggestionsUpdated: "Sugerencias actualizadas",
      synced: "Resincronizados",
      synonymRequests: "Solicitudes de sinónimos a la IA",
      targetsConsidered: "Destinos de enlace comprobados",
      total: "Entradas en total",
  ...
  seo: {
    ...
    hreflangPage: {
      ...
      coverageSummary: "{translated} de {total} traducidos por completo",
      allTranslated: "Todo el contenido analizado está traducido por completo en este idioma.",
      missingTitle: "{count} elementos sin traducir por completo",
      translate: "Traducir",
      showMore: "Mostrar {count} más",
      showLess: "Mostrar menos",
      meaningNote: "Un elemento cuenta como traducido solo cuando lo está cada campo que tiene texto en tu idioma principal. Antes bastaba con un único campo traducido, así que este porcentaje puede ser más bajo que antes: la laguna siempre estuvo ahí, solo que no se mostraba.",
      scopeNote: "Se revisan el título, la descripción, el título SEO y la descripción SEO de productos, colecciones, páginas y artículos de blog. Los metacampos, las opciones de variante, los textos del tema, los metaobjetos, las políticas y los menús no entran en esta cifra.",
      byTypeTitle: "Por tipo de contenido",
      typeSummary: "{complete} de {scanned} completos",
      ...
      fieldGapCount: "{label}: {count}",
      missingFields: "Falta: {fields}",
      fields: {
        title: "Título",
        body_html: "Descripción",
    ...
    performancePage: {
      ...
      errors: {
        ...
        dailyLimitReached: "Has alcanzado tu límite diario de {limit} pruebas. El límite se restablece cada día a las 00:00 UTC.",
      },
      budgetBadge: "Quedan {remaining} de {limit} pruebas hoy",
      budgetExhausted: "Límite diario alcanzado ({used}/{limit}). Se restablece a las 00:00 UTC — las pruebas ya realizadas siguen disponibles.",
      ...
      staleDailyLimitNotice: "Mostrando un resultado en caché — has alcanzado tu límite diario de {limit} pruebas. A partir de las 00:00 UTC podrás hacer una prueba nueva.",
      tabs: {
  ...
  bulkEditor: {
    ...
    retranslationCapped: "En {count} fila(s) más las traducciones desactualizadas no se rehicieron: cada guardado inicia un número limitado de ejecuciones en segundo plano. Según tu configuración se eliminaron o se dejaron como estaban. Guarda esas filas por separado para que también se vuelvan a traducir.",
    retranslationSkipped: "En {count} elemento(s) no se pudo iniciar la retraducción; sus traducciones actuales quedaron intactas. Vuelve a guardar el elemento para reintentarlo.",
  ...
  help: {
    ...
    autoTranslateHandles: {
      ...
      tips: [
        ...
        "Los idiomas sin handle propio también reciben uno traducido, tanto si cambias el handle aquí en la app como en el admin de Shopify. Los enlaces antiguos siguen funcionando",
        "Donde no se puede crear una redirección, el handle antiguo se queda: la retraducción nunca lo elimina",
      ],
      details:
        "El valor traducido se normaliza a un slug válido; lo que no se puede normalizar se descarta en lugar de escribirse. Un idioma que no tenía handle propio recibe uno traducido; su dirección anterior (el handle del idioma principal bajo el prefijo del idioma) queda cubierta por la redirección del idioma principal, y Shopify la lleva a la dirección traducida. Los borradores que nunca fueron públicos no necesitan redirección. El handle también se queda como está cuando la dirección antigua pertenece todavía a otro idioma o a otro elemento, en traducciones específicas de un mercado, en blogs (las URL de sus artículos no podrían acompañarlo), en artículos bajo un blog con handle traducido propio, cuando, para un handle traducido existente, la opción «Redirección al cambiar el identificador» está desactivada, o cuando la traducción no llega. En esos casos el handle traducido antiguo no se elimina: una dirección desactualizada funciona, una eliminada no. Lo mismo vale en el editor masivo cuando un guardado necesitaría más ejecuciones de las permitidas: los demás campos vuelven a la opción de eliminar, el handle se queda.",
    },
    menuActionBar: {
