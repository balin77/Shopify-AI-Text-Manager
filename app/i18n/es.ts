...
export const es: Translation = {
  ...
  bulkEditor: {
    ...
    retranslationStarted: "{count} traducción(es) se están rehaciendo en segundo plano; sigue el progreso en Tareas.",
