...
export const es: Translation = {
  ...
  tasks: {
    ...
    taskType: {
      ...
      altTextTemplateApply: "Plantillas de texto alt aplicadas",
      ...
      aiDiscoveryIntro: "Texto introductorio de IA",
    },
    status: {
      pending: "Pendiente",
    ...
    resourceType: {
      ...
      seo: "SEO",
      templateTitles: "Plantillas de correo",
    },
    fieldType: {
      title: "Título",
      description: "Descripción",
    ...
    resultLabels: {
      ...
      characters: "Caracteres",
      crawlCapped: "El rastreo alcanzó su límite de páginas — no se visitaron todas.",
      demotedToSecondary: "Degradadas a secundaria",
      errors: "Errores",
      ...
      galleryVideosMissingDate: "Vídeos de galería sin fecha de subida",
      galleryVideosVimeo: "Productos con vídeos de galería de Vimeo",
      headDrift: "Páginas con etiquetas head divergentes",
      internalLinksCapped: "Se alcanzó el límite de sugerencias pendientes — algunas coincidencias no se guardaron.",
      items: "Elementos",
      itemsAvailable: "Elementos disponibles",
      ...
      mediaVideosMissingDate: "Vídeos del producto sin fecha de subida",
      orphanPages: "Páginas huérfanas",
      pagesBlocked: "Páginas bloqueadas por un escudo antibots",
      ...
      targetsConsidered: "Destinos de enlace considerados",
      total: "Total",
