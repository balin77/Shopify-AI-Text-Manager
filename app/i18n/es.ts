...
export const es: Translation = {
  ...
  seo: {
    ...
    structuredDataPage: {
      ...
      introStep1: "**El paso 1** muestra qué entregan hoy tus páginas.",
      introStep2: "**El paso 2** comprueba si tus datos de producto bastan para un rich result.",
      introStep3: "**El paso 3** activa elementos concretos, pero solo los que aún no entrega nadie.",
