  ...
  seo: {
    ...
    structuredDataPage: {
      ...
      activation: {
        ...
        socialSwitchesTitle: "Bloque \"Open Graph / Twitter\"",
        socialSwitchesBody: "Este bloque solo tiene UN interruptor en el editor de temas, pero coloca nueve etiquetas. Como tu tema suele poner og:title y og:image por su cuenta y dejar twitter:* sin tocar, aquí aparece cada etiqueta por separado — el interruptor solo es seguro mientras ninguna esté en rojo.",
        ...
        socialOriginUnknownHint: "Este rastreo no puede decir qué etiquetas sociales proceden de esta app — o el bloque de Open Graph está DESACTIVADO, o el rastreo es anterior al marcador de origen del bloque. Ese marcador llega con esta actualización: tras la próxima publicación de la extensión y un rastreo nuevo aparecerá aquí una recomendación.",
        title: "Interruptor a interruptor: ¿qué puede activarse?",
        intro: "Cada interruptor del bloque \"JSON-LD Structured Data\", junto al hallazgo del paso 1. Conviene saberlo: nuestro bloque de producto usa a propósito el mismo @id que el esquema de tu tema, porque está pensado para SUSTITUIRLO. Si funcionan los dos, Google los fusiona en un solo nodo y cada campo que ambos entregan aparece dos veces — eso no es marcado duplicado, es marcado inválido.",
        noCrawl: "Todavía no hay ningún rastreo del sitio completado. Sin medición no hay recomendación aquí — ejecuta primero el paso 1.",
        notMeasured: "El último rastreo es anterior a este análisis y no capturó datos JSON-LD. Sin medición no hay recomendación aquí — inicia un rastreo nuevo.",
        basis: "Base: rastreo del {time}, {pages} páginas entregadas comprobadas.",
        originUnknownHint: "Este rastreo no puede decir qué marcado procede de esta app. Hay dos causas y los datos no permiten distinguirlas: o el bloque JSON-LD está DESACTIVADO en tu tema (entonces lo que ves abajo lo entrega tu tema), o el rastreo es anterior a la detección de origen. Mientras sea así, para cada interruptor de abajo vale lo mismo: no lo actives de nuevo y, si ya está activo, no cambies nada hasta que un rastreo nuevo lo resuelva.",
        switchesTitle: "Interruptores del bloque \"JSON-LD Structured Data\"",
        defaultOn: "Por defecto: activado.",
        defaultOff: "Por defecto: desactivado.",
        repeatableCaveat: "Varios bloques de este tipo en una página son normales — tres vídeos de producto son tres VideoObjects. Por eso aquí no se puede medir la duplicación; este campo se queda a propósito sin veredicto en vez de fingir estar \"comprobado y limpio\".",
        themeHint: "El marcado de tu tema se desactiva en el editor de temas, no aquí: esta app nunca toca código de tema que no sea suyo. Nombra el conflicto — la decisión sigue siendo tuya.",
        switches: {
        ...
        verdictLabels: {
          unknown: "Sin medir",
          free: "Se puede activar",
          appOnly: "Funciona limpio",
          foreignOnly: "Tu tema ya lo entrega",
          mixed: "Desigual",
          originUnknown: "Origen poco claro — no activar",
          repeatableUnjudged: "No evaluable",
          duplicateApp: "Duplicado — con solución aquí",
          duplicateForeign: "Duplicado — no es nuestro",
        },
        verdicts: {
          unknown: "Sin medición, sin recomendación. Ejecuta el paso 1 y aquí aparecerá un veredicto.",
          free: "Ninguna página rastreada entrega este tipo desde ninguna fuente. Puedes activar el interruptor sin riesgo.",
          appOnly: "Entregado en {pages} páginas, exactamente una vez por página y por esta app. Es el estado deseado — no hay nada que hacer.",
          foreignOnly: "Entregado en {pages} páginas, ninguna de ellas por esta app — o sea, por tu tema o por otra app. Si activas este interruptor, el tipo aparecerá dos veces en la página. Déjalo apagado o retira antes la otra fuente.",
          mixed: "Entregado en {pages} páginas, {appPages} de ellas por esta app; en el resto viene de tu tema o de otra app. Decide qué fuente conservar — si no, lo que ve Google depende de la plantilla de página.",
          originUnknown: "Entregado en {pages} páginas — pero no puede determinarse si alguna de las copias es nuestra (bloque desactivado, o rastreo anterior a la detección de origen). Por eso no lo actives de nuevo: el tipo ya está ahí y una segunda copia sería una de más. Si ya está activo, déjalo hasta que un rastreo nuevo muestre el origen.",
          repeatableUnjudged: "Entregado en {pages} páginas, {appPages} de ellas con bloques de esta app. No se puede medir si tu tema marca además los mismos vídeos.",
          duplicateApp: "Este tipo aparece más de una vez en {duplicatePages} páginas — en {appIsOneCopy} de ellas una de las copias es nuestra. Desactiva este interruptor y solo quedará la versión de tu tema, con lo que el error desaparece. También vale al revés: una de las dos fuentes tiene que irse, y cuál es cosa tuya.",
          duplicateForeign: "Este tipo aparece más de una vez en {duplicatePages} páginas, pero ninguna de las copias procede de esta app. Nuestro interruptor no lo arregla — las fuentes son tu tema y/u otra app. Busca \"application/ld+json\" en el código fuente de la página y compara los bloques.",
        },
      },
