...
export const es: Translation = {
  ...
  settings: {
    ...
    autoTranslateExternalChangesHelp: "Cuando un texto del idioma principal cambia — en el admin de Shopify, en otra app, mediante una importación o aquí en ContentPilot —, la IA lo vuelve a traducir en lugar de solo eliminar la traducción desactualizada. En productos y colecciones ocurre automáticamente en la siguiente sincronización. En todo lo demás — páginas, blogs, artículos, políticas, opciones, metacampos, metaobjetos, textos del tema, textos alternativos y títulos de menú — ocurre al guardar en el editor; si el texto se cambió fuera, en la siguiente recarga del elemento. En el editor masivo se sigue eliminando. Consume crédito de IA sin que estés presente. Los handles de URL quedan excluidos y solo se eliminan.",
    autoTranslateExternalChangesPlanHint: "Disponible a partir del plan {plan}.",
    translationPurgeSupersededNote: "No hace falta mientras los textos se vuelvan a traducir automáticamente: en productos y colecciones en la siguiente sincronización, y en todo lo demás al guardar en el editor — páginas, blogs, artículos, políticas, opciones, metacampos, metaobjetos, textos del tema, textos alternativos y títulos de menú. Allí el texto desactualizado se reemplaza en lugar de eliminarse. En el editor masivo se sigue eliminando: allí un guardado de 200 filas iniciaría 200 ejecuciones de IA sin supervisión.",
