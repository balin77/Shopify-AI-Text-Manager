  ...
  seo: {
    ...
    structuredDataPage: {
      ...
      activation: {
        ...
        socialOriginUnknownHint: "Por qué abajo no aparece el origen: o nuestro bloque de Open Graph está **desactivado**, o el rastreo es anterior al marcador de origen — que llega con esta actualización. Si el bloque está activo, el siguiente rastreo tras publicar la extensión mostrará el origen.",
        ...
        originUnknownHint: "Por qué abajo no aparece el origen: o nuestro bloque está **desactivado** — entonces lo que ves lo entrega tu tema — o el rastreo es anterior a la detección de origen. Ninguna de las dos cambia el consejo: no actives nada.",
