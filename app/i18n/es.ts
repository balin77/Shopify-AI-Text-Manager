  ...
  seo: {
    ...
    structuredDataPage: {
      ...
      activation: {
        ...
        originUnknownHint: "No se encontró ningún marcador de esta app. Lo que abajo se considera ajeno es por tanto muy probable, pero no está probado — un rastreo nuevo lo prueba.",
