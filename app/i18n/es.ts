...
export const es: Translation = {
  ...
  settings: {
    ...
    autoTranslateExternalChangesHelp: "Cuando un texto del idioma principal cambia — en el admin de Shopify, en otra app, mediante una importación o aquí en ContentPilot —, la IA lo vuelve a traducir en lugar de solo eliminar la traducción desactualizada. En productos y colecciones ocurre automáticamente en la siguiente sincronización; en el resto, en la siguiente recarga del elemento. Consume crédito de IA sin que estés presente. Los handles de URL quedan excluidos y solo se eliminan.",
    autoTranslateExternalChangesPlanHint: "Disponible a partir del plan {plan}.",
    translationPurgeSupersededNote: "No hace falta para productos y colecciones mientras los textos se vuelvan a traducir automáticamente: allí el texto desactualizado se reemplaza en lugar de eliminarse. En todo lo demás (páginas, blogs, artículos, políticas, metaobjetos, textos del tema, opciones, metacampos, textos alternativos) se sigue eliminando: esos solo se vuelven a traducir con una recarga, y una traducción sin su original no puede quedarse publicada.",
