...
export const es: Translation = {
  ...
  tasks: {
    ...
    resultLabels: {
      ...
      retranslationsCapped: "Eliminadas en su lugar (límite alcanzado)",
      skipped: "Omitidos",
  ...
  bulkEditor: {
    ...
    retranslationCapped: "En {count} fila(s) más las traducciones desactualizadas se eliminaron en lugar de rehacerse: cada guardado inicia como máximo 25 ejecuciones en segundo plano. Guarda esas filas por separado para que también se vuelvan a traducir.",
