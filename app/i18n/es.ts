...
export const es: Translation = {
  ...
  bulkEditor: {
    ...
    retranslationCapped: "En {count} fila(s) más las traducciones desactualizadas se eliminaron en lugar de rehacerse: cada guardado inicia un número limitado de ejecuciones en segundo plano. Guarda esas filas por separado para que también se vuelvan a traducir.",
