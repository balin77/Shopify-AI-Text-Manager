export const de = {
  ...
  seo: {
    ...
    sections: {
      ...
      performance: {
        label: "Ladezeit",
        title: "Ladezeit-Analyse (PageSpeed)",
        description: "Testet die Ladezeit einzelner Seiten mit Google PageSpeed Insights und zeigt Core Web Vitals, Screenshot-Auffälligkeiten und echte Nutzerdaten.",
      },
      keywords: {
        label: "Keywords",
    ...
    performancePage: {
      ...
      helpBody1: "Der Ladezeit-Test ruft Google PageSpeed Insights für eine ausgewählte Seite deines Shops auf und misst die Core Web Vitals — die Kennzahlen, mit denen Google die tatsächliche Ladeerfahrung deiner Besucher bewertet und die auch ins Google-Ranking einfließen. Du bekommst einen Performance-Score, einen Screenshot mit markierten Problemstellen und konkrete Verbesserungsvorschläge.",
      helpBody2: "Ein Testlauf dauert etwa 15–30 Sekunden, da Google die Seite live lädt und analysiert. Ergebnisse werden 30 Minuten zwischengespeichert — mit \"Erneut testen\" erzwingst du einen frischen Durchlauf.",
    ...
    bulkMetaPage: {
      intro: "Bearbeite alle Felder eines Eintrags direkt in einer Tabelle. Es werden nur geänderte Zellen gespeichert. Über \"Spalten wählen\" bestimmst du, was angezeigt wird.",
      typeLabel: "Typ",
      types: {
        product: "Produkte",
        collection: "Kollektionen",
      ...
      queuedRunning: "Für diesen Shop läuft bereits ein Massen-Meta-Speichern.",
