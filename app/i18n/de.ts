export const de = {
  ...
  seo: {
    ...
    aeoPage: {
      ...
      llmsAutoOn: "An — kurz nach jedem Öffnen der App und danach etwa halbstündlich, solange sie offen ist, prüfen wir im Hintergrund, ob dein Katalog von der Datei abweicht, und schreiben sie nur bei einer echten Abweichung neu. Änderungen, die du direkt in Shopify machst, werden dabei mitberücksichtigt.",
      llmsAutoAfterFirst: "An — sobald die Datei einmal erzeugt ist, halten wir sie automatisch aktuell: kurz nach jedem Öffnen der App und danach etwa halbstündlich. Von selbst angelegt wird sie nicht.",
      ...
      shopDescriptionMissingBody: "In deiner llms.txt fehlt die Zusammenfassungszeile — der eine Satz, an dem eine KI erkennt, worum es in deinem Shop überhaupt geht. Wir ziehen ihn aus der Shop-Beschreibung in Shopify, und die ist bei dir noch leer. Trage sie dort ein und erzeuge die llms.txt danach neu. Wir erfinden bewusst keine Beschreibung für dich.",
