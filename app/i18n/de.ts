export const de = {
  ...
  seo: {
    ...
    aeoPage: {
      ...
      robotsBlocked: "Folgende KI-Crawler sind in deiner robots.txt blockiert — sie können deine Inhalte dann nicht für KI-Suche nutzen:",
      partiallyBlockedTitle: "Einige KI-Crawler sind teilweise blockiert",
      partiallyBlockedBody: "Für diese KI-Crawler sind in deiner robots.txt einzelne Pfade gesperrt — sie sind nicht vollständig blockiert, aber ein Teil deines Storefronts bleibt ihnen verborgen. Prüfe „templates/robots.txt.liquid“.",
