  ...
  seo: {
    ...
    structuredDataPage: {
      ...
      activation: {
        ...
        socialOriginUnknownHint: "Dieser Crawl kann nicht sagen, welche Social-Tags von dieser App stammen — entweder ist das Open-Graph-Embed AUS, oder der Crawl ist älter als das Herkunftsmerkmal im Block. Das Merkmal kommt mit diesem Update neu dazu: Nach dem nächsten Extension-Release und einem frischen Crawl steht hier eine Empfehlung.",
        ...
        originUnknownHint: "Dieser Crawl kann nicht sagen, welches Markup von dieser App stammt. Dafür gibt es zwei Gründe und sie sind aus den Daten nicht zu unterscheiden: Entweder ist das JSON-LD-Embed im Theme AUS (dann liefert dein Theme aus, was du unten siehst), oder der Crawl ist älter als die Herkunftserkennung. Solange das so ist, gilt für jeden Schalter unten dasselbe: schalte ihn nicht neu ein, und wenn er schon an ist, ändere nichts, bevor ein neuer Crawl das aufgelöst hat.",
        ...
        verdictLabels: {
          ...
          mixed: "Uneinheitlich",
          originUnknown: "Herkunft unklar — nicht einschalten",
        ...
        verdicts: {
          ...
          originUnknown: "Auf {pages} Seiten ausgeliefert — aber ob eine der Kopien von dieser App stammt, ist nicht feststellbar (Embed aus, oder Crawl älter als die Herkunftserkennung). Schalte diesen Schalter deshalb nicht neu ein: Der Typ ist bereits da, und eine zweite Kopie wäre eine zu viel. Ist er schon an, lass ihn, bis ein neuer Crawl die Herkunft zeigt.",
