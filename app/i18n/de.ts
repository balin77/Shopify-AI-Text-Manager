export const de = {
  ...
  settings: {
    ...
    contentTemplatesDescription: "Wiederverwendbare Prompt-Vorlagen für die KI-Generierung. Lege pro Inhaltstyp (Produkt, Sammlung, Blogartikel, Seite, Richtlinie) und Feld (Titel, Beschreibung, SEO-Titel, Meta-Beschreibung, URL-Handle) eine Vorlage an — Platzhalter wie {{title}}, {{description}} oder {{language}} werden vor dem KI-Aufruf mit den aktuellen Inhaltsdaten ersetzt. Markiere eine Vorlage pro Inhaltstyp + Feld als Standard, damit sie beim Generieren oder Formatieren dieses Felds automatisch angewandt wird.",
    contentTemplatesApplyNote: "Gilt für neue KI-Aufrufe — bereits generierte Inhalte ändern sich erst beim nächsten Generieren/Formatieren. Vorlagen werden zusätzlich zu deinen Custom-Instructions aus den KI-Einstellungen angewandt (Custom-Instructions zuerst, dann die Vorlage).",
    contentTemplatesNewTemplate: "Neue Vorlage",
    contentTemplatesEditTemplate: "Vorlage bearbeiten",
    contentTemplatesName: "Name",
    contentTemplatesContentType: "Inhaltstyp",
    contentTemplatesField: "Feld",
    contentTemplatesPrompt: "Prompt-Vorlage",
    contentTemplatesAvailableVars: "Verfügbare Variablen: {vars}",
    contentTemplatesIsDefault: "Automatisch anwenden (Standard für diesen Inhaltstyp + Feld)",
    contentTemplatesSave: "Speichern",
    contentTemplatesCancel: "Abbrechen",
    contentTemplatesEmptyHeading: "Noch keine Vorlagen",
    contentTemplatesEmptyBody: "Lege wiederverwendbare Prompt-Vorlagen an, um die KI-Ausgabe katalogweit konsistent zu halten.",
    contentTemplatesDefaultBadge: "Standard",
    contentTemplatesMakeDefault: "Als Standard setzen",
    contentTemplatesEditRow: "Bearbeiten",
    contentTemplatesDeleteRow: "Löschen",
    contentTemplatesContentTypeProducts: "Produkte",
    contentTemplatesContentTypeCollections: "Sammlungen",
    contentTemplatesContentTypeBlogs: "Blogartikel",
    contentTemplatesContentTypePages: "Seiten",
    contentTemplatesContentTypePolicies: "Richtlinien",
    contentTemplatesDefaultRaceError: "Der Standard wurde gerade in einem anderen Fenster geändert. Bitte lade die Seite neu und versuche es erneut.",
    // Glossar-Tab
    glossary: "Glossar",
    glossaryScopeNote: "Hinweis: Das Glossar greift nur bei KI-Übersetzungen, nicht beim Generieren neuer Inhalte. Möchtest du steuern, wie die KI Titel/Beschreibungen erzeugt, nutze die Vorlagen oben oder die Custom-Instructions unter \"KI-Einstellungen\".",
  ...
  seo: {
    ...
    bulkMetaPage: {
      intro: "Bearbeite Titel, SEO-Titel, Meta-Description und Handle direkt in einer Tabelle. Es werden nur geänderte Zellen gespeichert.",
      typeLabel: "Typ",
      types: {
        product: "Produkte",
        collection: "Kollektionen",
