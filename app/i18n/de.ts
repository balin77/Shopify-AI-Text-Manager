export const de = {
  ...
  imageManager: {
    ...
    bulkDocsExample: "Beispiel: Tshirt_Blue_M_001.jpg → SKU: Tshirt_Blue_M",
    bulkDocsCaseSensitive: "Gross-/Kleinschreibung und Reihenfolge der Varianten müssen exakt mit der SKU übereinstimmen.",
