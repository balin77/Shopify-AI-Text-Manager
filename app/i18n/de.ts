export const de = {
  ...
  bulkEditor: {
    ...
    retranslationCapped: "Bei {count} weiteren Zeile(n) wurden die veralteten Übersetzungen gelöscht statt neu erstellt: pro Speichern ist die Zahl der Hintergrund-Läufe begrenzt. Speichere diese Zeilen einzeln, um sie ebenfalls neu übersetzen zu lassen.",
