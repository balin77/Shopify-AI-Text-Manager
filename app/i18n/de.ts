export const de = {
  ...
  seo: {
    ...
    structuredDataPage: {
      ...
      introStep1: "**Schritt 1** zeigt, was deine Seiten heute ausliefern.",
      introStep2: "**Schritt 2** prüft, ob deine Produktdaten für ein Rich Result reichen.",
      introStep3: "**Schritt 3** schaltet einzelne Elemente zu — aber nur die, die noch niemand liefert.",
