export const de = {
  ...
  settings: {
    ...
    seoLimitTitleMin: "Titel min.",
    seoLimitTitleMax: "Titel max.",
    seoLimitSeoTitleMax: "SEO-Titel max.",
    seoLimitMetaDescMin: "Meta-Beschreibung min.",
    seoLimitMetaDescMax: "Meta-Beschreibung max.",
    seoLimitDescriptionMin: "Beschreibung min.",
