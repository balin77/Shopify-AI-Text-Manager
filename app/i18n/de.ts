  ...
  seo: {
    ...
    structuredDataPage: {
      ...
      activation: {
        ...
        socialOriginUnknownHint: "Warum unten keine Herkunft steht: Entweder ist unser Open-Graph-Embed **aus**, oder der Crawl ist älter als das Erkennungsmerkmal — das kommt mit diesem Update. Ist das Embed an, zeigt der nächste Crawl nach dem Extension-Release die Herkunft.",
        ...
        originUnknownHint: "Warum unten keine Herkunft steht: Entweder ist unser Embed **aus** — dann liefert dein Theme aus, was du siehst — oder der Crawl ist älter als die Herkunftserkennung. Beides ändert nichts am Rat: nichts neu einschalten.",
