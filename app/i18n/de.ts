export const de = {
  ...
  content: {
    ...
    redirectNotConfirmed: "Die alte URL {path} konnte nicht weitergeleitet werden — lege sie bei Bedarf in Shopify selbst an.",
    redirectFailed: "Die alte URL {path} konnte nicht weitergeleitet werden — lege sie bei Bedarf in Shopify selbst an.",
    redirectBlogArticlesUncovered: "Die alte Blog-URL {path} leitet jetzt weiter — die Artikel-URLs dieses Blogs aber nicht.",
    redirectShadowRemoved: "Die alte URL {path} leitet jetzt weiter. Eine Weiterleitung auf der neuen URL wurde entfernt — sie hätte die Seite verdeckt.",
    redirectMissingBlog: "Die alte Artikel-URL wurde nicht weitergeleitet: Blog unbekannt. Lege sie bei Bedarf in Shopify selbst an.",
    redirectLocaleBlogUnknown: "Die alte Artikel-URL wurde nicht weitergeleitet: Der Blog-Handle ist ebenfalls übersetzt. Lege sie bei Bedarf selbst an.",
    reload: "Neu laden",
    ...
    menuRenameIdsReassigned: "Shopify hat den umbenannten Menüpunkten neue IDs gegeben. Ihre bisherigen Übersetzungen hängen an den alten IDs und müssen neu erfasst werden.",
    menuRenamePurgedTranslations: "{count} Übersetzung(en) wurden entfernt, weil ihr Ausgangstext geändert wurde (Einstellungen → Übersetzungen).",
    ...
    // Setup
    syncFailedTitle: "Es konnte nicht alles synchronisiert werden",
    syncFailedSome: "{count} Eintrag/Einträge konnten nicht von Shopify geladen werden. Für sie hat sich nichts geändert — den Grund nennt das Log.",
    syncFailedAll: "Die Synchronisierung konnte nicht abgeschlossen werden.",
    ...
    commerce: {
      ...
      skuBarcodeNotBulk: "SKU und Barcode gehören zu je einer einzelnen Variante und werden deshalb einzeln bearbeitet.",
      ...
      notStockedEveryVariant: "nicht bei allen Varianten bestandsgeführt",
      ...
      stockUnknown: "Noch nicht geladen — lade neu, um den Bestand zu sehen.",
      stockUntracked: "Für diese Variante wird kein Bestand geführt — sie kann unbegrenzt verkauft werden.",
      stockUntrackedBulk: "Für diese Varianten wird kein Bestand geführt — sie können unbegrenzt verkauft werden.",
      stockSomeNotTracked: "{n} von {m} Varianten führen hier keinen Bestand und stehen nicht in der Tabelle — ihr Bestand bleibt, wie er ist.",
      stockBulkHint: "Eine Zahl unter „Auf Lager“ wird für JEDE der {n} Varianten gesetzt. ≠ heißt: Die Varianten unterscheiden sich hier.",
      stockNoItem: "Diese Variante hat keinen Bestandsdatensatz, ihr Bestand lässt sich hier nicht bearbeiten.",
      levelsTruncated: "Es gibt Bestand an mehr Lagerorten, als geladen wurden.",
      noLevels: "Kein Lagerort führt hierfür Bestand.",
    ...
    createModal: {
      ...
      noneOption: "\u2014",
      // Was ein Feld IST, im ❓ neben dem Label — nie als Hilfstext unter der
      // Box. Schlüssel wie `CreateFieldDef.labelKey`.
      fieldHelp: {
        keyword: "Fließt in den KI-Prompt ein und wird zum Hauptkeyword dieses Eintrags.",
        handle: "Der Teil der URL nach /collections/, /products/ usw. Optional: bleibt das Feld leer, leitet Shopify den Handle aus dem Titel ab. Ist er schon vergeben, hängt Shopify eine Zahl an.",
        tags: "Mehrere Tags mit Komma trennen.",
      },
  ...
  tasks: {
    ...
    // Pagination
    tasksFound: "{count} Aufgabe(n) gefunden",
    page: "Seite",
    of: "von",
    // Task Types
    taskType: {
      ...
      seoBulkFix: "SEO-Massenkorrektur",
      ...
      // PLAN_TASK_LIST_CLARITY B1 — Typen, die zwar erzeugt, aber nie
      // beschriftet wurden und deshalb ihren rohen Bezeichner als Überschrift
      // gezeigt haben. `bulkAIGeneration` bekommt bewusst KEINEN eigenen
      // Schlüssel: das ist die zweite Schreibweise von `bulkAiGeneration` und
      // wird über die Alias-Tabelle in task-labels.shared.ts aufgelöst.
      aiFormatting: "Text-Formatierung",
    ...
    resourceType: {
      ...
      templates: "Theme-Texte",
      // Jede shopweite SEO-Aufgabe (8 Typen) trägt das hier — sie gehört zu
      // keinem einzelnen Objekt.
      seo: "SEO",
      templateTitles: "Benachrichtigungs-Vorlagen",
    },
    fieldType: {
      title: "Titel",
      description: "Beschreibung",
      ...
      all: "Alle Felder",
      altText: "Alt-Text",
      altTextTemplate: "Alt-Text-Vorlage",
      "sub-resources": "Optionen & Metafelder",
      "direct-translations": "Direkte Übersetzungen",
      autoTranslateExternalChange: "Neuübersetzung nach externer Änderung",
      suggest: "Vorschläge",
      apply: "Anwenden",
      multi: "Mehrere Felder",
      robots: "robots.txt-Regeln",
      llms: "llms.txt",
      agents: "agents.md",
    },
    // Expandable details
    ...
    // ── Aufgeklappte Aufgaben-Details (PLAN_TASK_LIST_CLARITY §3.3) ───────
    resultHeading: "Ergebnis",
    failuresHeading: "Fehlgeschlagene Einträge",
    failuresMore: "+{n} weitere",
    detailsLoading: "Details werden geladen…",
    detailsError: "Details konnten nicht geladen werden.",
    detailsEmpty: "Zu dieser Aufgabe wurden keine weiteren Details gespeichert.",
    redirectsOverCap: "{n} Artikel haben keine Weiterleitung bekommen — ihre alten URLs liefern jetzt 404.",
    // Werden direkt von TaskDetailsPanel / MainNavigation gelesen — keine
    // labelKeys. `{id}` ist die Nummer aus einer Markt-GID, `{language}` ein
    // Sprachname.
    marketLabel: "Markt {id}",
    localeNotSaved: "{language} — nicht gespeichert",
    fixAllSubject: "Alle Probleme · {resource} {id}",
    partialLocalesHint: "Einige Sprachen konnten nicht gespeichert werden — Details im Aufgaben-Tab.",
    // Bewusst derselbe Satz wie bulkEditor.translateMissing.noneMissing: eine
    // Formulierung für "es gab nichts zu übersetzen".
    nothingToDo: "In der aktuellen Auswahl fehlt keine Übersetzung.",
    failureFieldFallback: "Feld",
    // Ein Schlüssel pro labelKey aus summariseTaskResult()
    // (task-details.shared.ts). Kurze Substantiv-Phrasen — der Wert steht
    // daneben. Die drei Limit-Einträge tragen bewusst einen ganzen Satz: sie
    // werden als Warnzeile ohne Wert gerendert.
    resultLabels: {
      altTextsGenerated: "Alt-Texte generiert",
      applied: "Angewendet",
      attempted: "Versucht",
      averageScore: "Durchschnittliche Punktzahl",
      batches: "KI-Batches",
      capped: "Der Scan hat sein Limit erreicht — es wurde nicht alles geprüft.",
      characters: "Zeichen",
      crawlCapped: "Der Crawl hat sein Seitenlimit erreicht — nicht jede Seite wurde besucht.",
      crawlFailedReason: "Grund für den Fehler",
      demotedToSecondary: "Keywords zu sekundär herabgestuft",
      errors: "Fehler",
      externalBroken: "Externe Links tot",
      externalChecked: "Externe Links geprüft",
      externalFound: "Externe Links gefunden",
      externalTimedOut: "Externe Links mit Zeitüberschreitung",
      externalUnchecked: "Externe Links nicht geprüft",
      failed: "Fehlgeschlagen",
      failedBatches: "Batches ohne verwertbare Antwort",
      failedFields: "Fehlgeschlagene Felder",
      fieldsRejected: "Nicht gespeicherte Felder",
      fieldsSkipped: "Bewusst übersprungene Felder",
      fieldsTranslated: "Übersetzte Felder",
      file: "Datei",
      galleryVideoProducts: "Produkte mit Galerie-Videos",
      galleryVideosMissingDate: "Produkte mit Galerie-Video ohne Upload-Datum",
      ...
      itemsScanned: "Geprüfte Einträge",
      keywords: "Keywords",
      localesFailed: "Fehlgeschlagene Sprachen",
      localesSaved: "Gespeicherte Sprachen",
      localesTargeted: "Zielsprachen",
      localesTranslated: "Übersetzte Sprachen",
      mediaVideosMissingDate: "Produkte mit Produkt-Video ohne Upload-Datum",
      orphanPages: "Seiten ohne interne Verlinkung",
      pagesBlocked: "Von einem Bot-Schutz blockierte Seiten",
      pagesBroken: "Fehlerhafte Seiten",
      pagesCrawled: "Gecrawlte Seiten",
      pagesDiscovered: "Gefundene Seiten",
      pagesOk: "Seiten in Ordnung",
      pagesServerError: "Seiten mit Serverfehler",
      purged: "Veraltete Übersetzungen entfernt",
      redirectsCreated: "Weiterleitungen erstellt",
      retranslated: "Neu übersetzt",
      rulesAdvised: "Regeln mit Empfehlung",
      rulesTotal: "Geprüfte Regeln",
      savedRows: "Gespeicherte Zeilen",
      retranslationsStarted: "Neu übersetzt (Hintergrund)",
      retranslationsCapped: "Nicht neu übersetzt (Obergrenze erreicht)",
      retranslationsSkipped: "Neuübersetzung nicht gestartet",
      skipped: "Übersprungen",
      skippedDrafts: "Übersprungen (Entwürfe)",
      skippedHandles: "Übersprungene URL-Slugs",
      skippedOverCap: "Übersprungen (über dem Limit)",
      sourcesScanned: "Geprüfte Quellseiten",
      succeeded: "Erfolgreich",
      suggestionsCreated: "Vorschläge erstellt",
      suggestionsUpdated: "Vorschläge aktualisiert",
      synced: "Neu synchronisiert",
      synonymRequests: "KI-Anfragen für Synonyme",
      targetsConsidered: "Geprüfte Linkziele",
      total: "Einträge insgesamt",
      translated: "Übersetzt",
      translationsSaved: "Übersetzungen gespeichert",
    },
  },
  ...
  seo: {
    ...
    hreflangPage: {
      ...
      coverageSummary: "{translated} von {total} vollständig übersetzt",
      allTranslated: "Alle geprüften Inhalte sind in dieser Sprache vollständig übersetzt.",
      missingTitle: "{count} Inhalte sind nicht vollständig übersetzt",
      translate: "Übersetzen",
      showMore: "{count} weitere anzeigen",
      showLess: "Weniger anzeigen",
      meaningNote: "Ein Inhalt gilt erst dann als übersetzt, wenn jedes Feld übersetzt ist, das in deiner Primärsprache Text enthält. Bisher genügte ein einziges übersetztes Feld — dieser Prozentwert kann deshalb niedriger ausfallen als zuvor. Die Lücke war immer da, sie wurde nur nicht gezeigt.",
      scopeNote: "Geprüft werden Titel, Beschreibung, SEO-Titel und SEO-Beschreibung von Produkten, Kollektionen, Seiten und Blog-Artikeln. Metafelder, Variantenoptionen, Theme-Texte, Metaobjekte, Richtlinien und Menüs fließen hier nicht ein.",
      byTypeTitle: "Nach Inhaltstyp",
      typeSummary: "{complete} von {scanned} vollständig",
  ...
  bulkEditor: {
    ...
    retranslationStarted: "{count} Übersetzung(en) werden im Hintergrund neu erstellt — der Fortschritt steht unter Aufgaben.",
    retranslationCapped: "Bei {count} weiteren Zeile(n) wurden die veralteten Übersetzungen nicht neu erstellt: pro Speichern ist die Zahl der Hintergrund-Läufe begrenzt. Je nach deiner Einstellung wurden sie gelöscht oder unverändert gelassen. Speichere diese Zeilen einzeln, um sie ebenfalls neu übersetzen zu lassen.",
    retranslationSkipped: "Bei {count} Eintrag/Einträgen konnte die Neuübersetzung nicht gestartet werden — die bisherigen Übersetzungen bleiben unverändert stehen. Speichere den Eintrag erneut, um es noch einmal zu versuchen.",
