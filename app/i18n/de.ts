export const de = {
  ...
  settings: {
    ...
    autoTranslateExternalChangesHelp: "Ändert sich ein Text in der Hauptsprache — im Shopify-Admin, in einer anderen App, per Import oder hier in ContentPilot —, übersetzt die KI ihn neu, statt die veraltete Übersetzung nur zu löschen. Bei Produkten und Kollektionen passiert das automatisch beim nächsten Sync; bei allen anderen Inhalten beim nächsten Reload des Eintrags. Verbraucht KI-Guthaben ohne dein Zutun. URL-Handles bleiben ausgenommen und werden weiterhin nur gelöscht.",
    autoTranslateExternalChangesPlanHint: "Ab dem {plan}-Plan verfügbar.",
    translationPurgeSupersededNote: "Für Produkte und Kollektionen nicht nötig, solange automatisch neu übersetzt wird — dort wird der veraltete Text ersetzt statt gelöscht. Überall sonst (Seiten, Blogs, Artikel, Richtlinien, Metaobjekte, Theme-Texte, Optionen, Metafelder, Alt-Texte) wird weiter gelöscht: Diese Texte übersetzt nur ein Reload nach, und eine Übersetzung ohne Original darf nicht im Shop stehen bleiben.",
