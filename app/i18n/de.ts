export const de = {
  ...
  settings: {
    ...
    // App-Übersetzungen (dynamische Storefront-Übersetzung)
    appTranslations: "App-Übersetzungen",
    appTranslationsDescription: "Übersetze Texte von Drittanbieter-Apps, die auf deiner Storefront gerendert werden und nicht in übersetzbaren Shopify-Feldern liegen. Lege Original→Übersetzung-Paare pro Sprache an; sie werden auf der Storefront angewendet.",
    appTranslationsSeoNote: "Diese Übersetzungen werden im Browser angewendet und sind NICHT von Suchmaschinen indexierbar. Nutze für SEO-relevante Inhalte die Shopify-Feldübersetzungen. Apps in iframes (z. B. Loox) können nicht übersetzt werden.",
    appTranslationsEnable: "Dynamische Storefront-Übersetzung aktivieren",
    appTranslationsLanguage: "Sprache",
    appTranslationsAddHeading: "Übersetzung hinzufügen",
    appTranslationsSource: "Originaltext",
    appTranslationsSourcePlaceholder: "z. B. Write a review",
    appTranslationsTarget: "Übersetzung",
    appTranslationsAdd: "Hinzufügen",
    appTranslationsEmpty: "Noch keine Einträge für diese Sprache.",
    appTranslationsNoLocalesHeading: "Keine weiteren Sprachen",
    appTranslationsNoLocales: "Füge zuerst weitere veröffentlichte Sprachen in deinem Shopify-Shop hinzu.",
    appTranslationsAiHeading: "Mit KI übersetzen",
    ...
    appTranslationsTranslateAllAi: "Alle mit KI übersetzen",
    appTranslationsSeen: "Gesehen",
    appTranslationsUse: "Übersetzen",
    appTranslationsDismiss: "Verwerfen",
    sku: "SKU",
