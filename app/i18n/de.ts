export const de = {
  ...
  seo: {
    ...
    keywordsPage: {
      ...
      intro: "Lege pro Inhalt ein Primary-Keyword und bis zu 4 Secondary-Keywords fest. Die On-Page-Analyse läuft lokal (keine externe API).",
      typeLabel: "Typ",
      itemLabel: "Inhalt",
      ...
      addButton: "Speichern",
      pickerCapped: "Es werden bis zu {cap} Einträge pro Typ angezeigt.",
      ...
      groupNoKeywords: "Noch keine Keywords in dieser Gruppe — unten hinzufügen oder CSV importieren.",
      colAssignments: "Zuweisungen",
      groupRemoveKeyword: "Entfernen",
      groupAddKeywordLabel: "Keyword hinzufügen",
      groupAddKeyword: "Hinzufügen",
