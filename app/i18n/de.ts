export const de = {
  ...
  tasks: {
    ...
    taskType: {
      ...
      insertKeyword: "Keyword einfügen",
      altTextTemplateApply: "Alt-Text-Vorlagen angewendet",
      ...
      aiDiscoveryIntro: "KI-Einleitungstext",
    },
    status: {
      pending: "Wartend",
      running: "Läuft",
    ...
    resourceType: {
      ...
      seo: "SEO",
      templateTitles: "E-Mail-Vorlagen",
    },
    fieldType: {
      title: "Titel",
      description: "Beschreibung",
    ...
    resultLabels: {
      ...
      characters: "Zeichen",
      crawlCapped: "Der Crawl hat sein Seitenlimit erreicht — nicht jede Seite wurde besucht.",
      demotedToSecondary: "Zu sekundär herabgestuft",
      errors: "Fehler",
      ...
      galleryVideosMissingDate: "Galerie-Videos ohne Upload-Datum",
      galleryVideosVimeo: "Produkte mit Vimeo-Galerie-Videos",
      headDrift: "Seiten mit abweichenden Head-Tags",
      internalLinksCapped: "Das Limit für offene Vorschläge wurde erreicht — einige Treffer wurden nicht gespeichert.",
      items: "Objekte",
      itemsAvailable: "Objekte insgesamt",
      itemsScanned: "Objekte geprüft",
      keywords: "Keywords",
      ...
      mediaVideosMissingDate: "Produkt-Videos ohne Upload-Datum",
      orphanPages: "Verwaiste Seiten",
      ...
      synonymRequests: "KI-Synonym-Anfragen",
