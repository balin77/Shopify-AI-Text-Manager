export const de = {
  ...
  settings: {
    ...
    themeSetupNote: "Nach jeder Aktivierung das Theme speichern. Beide Blöcke gehören zur gleichen ContentPilot Storefront-Extension.",
