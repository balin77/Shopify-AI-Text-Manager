export const de = {
  ...
  settings: {
    ...
    autoTranslateExternalChangesHelp: "Ändert sich ein Text in der Hauptsprache — im Shopify-Admin, in einer anderen App, per Import oder hier in ContentPilot —, übersetzt die KI ihn neu, statt die veraltete Übersetzung nur zu löschen. Bei Produkten und Kollektionen passiert das automatisch beim nächsten Sync. Bei Seiten, Blogs, Artikeln und Richtlinien sofort, wenn du sie im Editor speicherst — wurde der Text ausserhalb geändert, beim nächsten Reload des Eintrags. Im Bulk-Editor werden diese vier weiterhin nur gelöscht. Verbraucht KI-Guthaben ohne dein Zutun. URL-Handles bleiben ausgenommen und werden weiterhin nur gelöscht.",
    autoTranslateExternalChangesPlanHint: "Ab dem {plan}-Plan verfügbar.",
    translationPurgeSupersededNote: "Für Produkte und Kollektionen nicht nötig, solange automatisch neu übersetzt wird — und für Seiten, Blogs, Artikel und Richtlinien, wenn du sie im Editor bearbeitest: Dort wird der veraltete Text ersetzt statt gelöscht. Im Bulk-Editor sowie bei Metaobjekten, Theme-Texten, Optionen, Metafeldern und Alt-Texten wird weiter gelöscht: Die übersetzt bisher nichts automatisch nach, und eine Übersetzung ohne Original darf nicht im Shop stehen bleiben.",
