export const de = {
  ...
  seo: {
    ...
    structuredDataPage: {
      ...
      schemaVideoNote: "Video entsteht erst auf der Storefront — aus deinen Produkt-Medien — und taucht deshalb in der Vorschau unten nicht auf. Das von Google verlangte Upload-Datum holt die App beim Produkt-Sync aus der Shopify-API und legt es als Metafeld \"custom.video_upload_dates\" ab; die Storefront liest es dort. Willst du für ein Produkt ein anderes Datum ausweisen (z. B. die Erstveröffentlichung auf YouTube), trägst du es im Metafeld \"custom.video_upload_date\" ein — deine Angabe gewinnt. Ohne beides lassen wir die Angabe weg statt sie zu erfinden. FAQ (FAQPage) kommt dazu, sobald du den Schalter im Theme-Editor einschaltest und das Metafeld \"custom.faq\" gefüllt ist — beides ist bewusst standardmäßig aus.",
      ...
      activation: {
        ...
        socialSwitchesTitle: "App-Block „Open Graph / Twitter\"",
        socialSwitchesBody: "Dieser Block hat im Theme-Editor nur EINEN Schalter, setzt aber neun Tags. Weil dein Theme typischerweise og:title und og:image selbst setzt und twitter:* nicht, steht hier jedes Tag einzeln — der Schalter ist nur dann gefahrlos, wenn keines davon rot ist.",
        ...
        socialOriginUnknownHint: "Dieser Crawl kann noch nicht unterscheiden, welche Social-Tags von dieser App stammen — er ist älter als die Herkunftserkennung im Open-Graph-Block. Ein neuer Crawl löst das auf.",
        title: "Schalter für Schalter: was darf an?",
        intro: "Jeder Schalter des App-Blocks „JSON-LD Structured Data\" steht hier mit dem Befund aus Schritt 1. Wichtig zu wissen: Unser Produkt-Block benutzt absichtlich dieselbe @id wie das Schema deines Themes, weil er es ERSETZEN soll. Laufen beide gleichzeitig, verschmilzt Google sie zu einem Knoten und jedes beidseitig gelieferte Feld steht doppelt drin — das ist nicht doppeltes, sondern ungültiges Markup.",
        noCrawl: "Noch kein abgeschlossener Website-Crawl. Ohne Messung gibt es hier keine Empfehlung — fahre zuerst Schritt 1.",
        notMeasured: "Der letzte Crawl ist älter als diese Auswertung und hat noch keine JSON-LD-Daten erfasst. Ohne Messung gibt es hier keine Empfehlung — starte einen neuen Crawl.",
        basis: "Grundlage: Crawl vom {time}, {pages} ausgelieferte Seiten geprüft.",
        originUnknownHint: "Dieser Crawl kann noch nicht unterscheiden, welches Markup von dieser App stammt — er ist älter als die Herkunftserkennung. Deshalb steht unten „Herkunft unklar\" statt einer Empfehlung. Ein neuer Crawl löst das auf.",
        switchesTitle: "Schalter im App-Block „JSON-LD Structured Data\"",
        defaultOn: "Standard: eingeschaltet.",
        defaultOff: "Standard: ausgeschaltet.",
        repeatableCaveat: "Mehrere Blöcke dieses Typs auf einer Seite sind normal — drei Produktvideos sind drei VideoObjects. Eine Doppelung ist hier deshalb nicht messbar; dieses Feld bleibt bewusst ohne Urteil, statt „geprüft und sauber\" vorzutäuschen.",
        themeHint: "Das Markup deines Themes schaltest du im Theme-Editor ab, nicht hier: Diese App fasst fremden Theme-Code grundsätzlich nicht an. Sie benennt den Konflikt — die Entscheidung bleibt bei dir.",
        switches: {
        ...
        verdictLabels: {
          ...
          free: "Kann an",
          appOnly: "Läuft sauber",
          foreignOnly: "Theme liefert das schon",
          mixed: "Uneinheitlich",
          originUnknown: "Herkunft unklar",
          repeatableUnjudged: "Nicht bewertbar",
          duplicateApp: "Doppelt — behebbar",
          duplicateForeign: "Doppelt — nicht bei uns",
        },
        verdicts: {
          unknown: "Ohne Messung keine Empfehlung. Fahre Schritt 1, dann steht hier ein Urteil.",
          free: "Auf keiner gecrawlten Seite liefert irgendjemand diesen Typ aus. Du kannst den Schalter gefahrlos einschalten.",
          appOnly: "Auf {pages} Seiten ausgeliefert, und zwar genau einmal pro Seite und von dieser App. Genau so soll es sein — nichts zu tun.",
          foreignOnly: "Auf {pages} Seiten ausgeliefert, keine davon von dieser App — also von deinem Theme oder einer anderen App. Schaltest du diesen Schalter ein, steht der Typ doppelt auf der Seite. Lass ihn aus, oder entferne zuerst die andere Quelle.",
          mixed: "Auf {pages} Seiten ausgeliefert, davon {appPages} von dieser App; auf den übrigen kommt er von deinem Theme oder einer anderen App. Entscheide, welche Quelle du behalten willst — sonst hängt es von der Seitenvorlage ab, was Google sieht.",
          originUnknown: "Auf {pages} Seiten ausgeliefert. Dieser Crawl kann noch nicht sagen, ob eine der Kopien von dieser App stammt. Starte einen neuen Crawl, dann steht hier eine Empfehlung.",
          repeatableUnjudged: "Auf {pages} Seiten ausgeliefert, davon {appPages} mit Blöcken dieser App. Ob dein Theme dieselben Videos zusätzlich auszeichnet, lässt sich nicht messen.",
          duplicateApp: "Auf {duplicatePages} Seiten steht dieser Typ mehrfach — auf {appIsOneCopy} davon ist eine der Kopien von dieser App. Schalte diesen Schalter aus, dann bleibt nur die Version deines Themes übrig und der Fehler ist weg. Umgekehrt geht es auch: eine der beiden Quellen muss weg, welche, entscheidest du.",
          duplicateForeign: "Auf {duplicatePages} Seiten steht dieser Typ mehrfach, aber keine der Kopien stammt von dieser App. Unser Schalter behebt das nicht — die Quellen sind dein Theme und/oder eine andere App. Such im Seitenquelltext nach „application/ld+json\" und vergleiche die Blöcke.",
        },
      },
