export const de = {
  ...
  seo: {
    ...
    performancePage: {
      ...
      fieldLcpLabel: "LCP (reale Nutzer)",
      fieldClsLabel: "CLS (reale Nutzer)",
      fieldInpLabel: "INP (reale Nutzer)",
      fieldFcpLabel: "FCP (reale Nutzer)",
      fieldTtfbLabel: "TTFB / Serverantwort (reale Nutzer)",
