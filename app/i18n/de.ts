export const de = {
  ...
  tasks: {
    ...
    resultLabels: {
      ...
      retranslationsCapped: "Stattdessen gelöscht (Obergrenze erreicht)",
  ...
  bulkEditor: {
    ...
    retranslationCapped: "Bei {count} weiteren Zeile(n) wurden die veralteten Übersetzungen gelöscht statt neu erstellt: pro Speichern werden höchstens 25 Hintergrund-Läufe gestartet. Speichere diese Zeilen einzeln, um sie ebenfalls neu übersetzen zu lassen.",
