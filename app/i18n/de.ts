export const de = {
  ...
  settings: {
    ...
    translationsVariantKeys: "Varianten-Match-Keys",
    translationsVariantKeysDescription: "Stabile ASCII-Schlüssel pro Optionswert für SKU- und Bild-Matching. Werden automatisch beim Speichern von Varianten erzeugt.",
    translationsVariantKeysEmpty: "Noch keine Varianten-Schlüssel gespeichert.",
    translationsVariantOriginal: "Anzeigename",
