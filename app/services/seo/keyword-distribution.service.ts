...
//
// Lives in keyword-distribution.shared.ts (client-safe — the keywords tab
// renders the cost preview in the browser, and THIS module imports the
// prompt sanitizer → logger.server). Re-exported here so the handler and
...
export {
  ...
  type DistributionCostEstimate,
} from "./keyword-distribution.shared";
