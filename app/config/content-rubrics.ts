...
export const CONTENT_RUBRICS: RubricDef[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { id: "shopMetadata", path: "/app/shop-metadata", icon: "🏪", labelKey: "shopMetadata", planContentType: "onlineStoreExtras" },
  ...
  },
  {
    ...
    entries: [
      ...
      { id: "themeStaticSections", path: "/app/theme-static-sections", icon: "🗂️", labelKey: "themeStaticSections", planContentType: "templates" },
